'''
# File 			: startBAM.py
# Description 	: Run startBAM command on devices provided by a file "deviceList.txt" which contains MAC Ids in each line.
...
# How to Run    : Run command "python startBAM.py"
...
fwrite = open('writeStatus_startBAM.txt', 'w')
...
for line in fread:
	...
	try:
		child.sendline('startBAM')								# Run startBAM command
